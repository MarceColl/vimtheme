...
local nfg = hsl("#505050")
local nbg = hsl("#dcdacb")
...
local theme = lush(function()
  return {
    ...
    -- Uncomment "Normal"
    Normal { bg = nbg, fg = nfg}, -- normal text
    ...
    Visual { bg = Normal.bg.darken(5), fg = Normal.fg.darken(40) },
    ...
    Comment { fg = Normal.fg.lighten(50), gui="italic" },
    ...
    -- information.
    -- (`setlocal number`)
    LineNr       { bg = Normal.bg.da(5), fg = Normal.fg.lighten(35) }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
    CursorLineNr { bg = CursorLine.bg, fg = Normal.fg.lighten(5) }, -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.

    -- We can also mix colours together
    Type         { fg = Normal.fg, gui = "bold" },

	Keyword      { gui = "bold" },
	TSKeyword    { gui = "bold" },
	Conditional      { gui = "bold" },
	TSConditional    { gui = "bold" },
	Identifier      { gui = "bold" },
	TSIdentifier    { gui = "bold" },
	Constant      { fg = Normal.fg },
	TSConstant      { fg = Normal.fg },
	Statement      { gui = "bold" },
	TSStatement    { gui = "bold" },
	String		 { fg = Normal.fg.lighten(10), gui = "italic" },
	TSString     { fg = Normal.fg.lighten(10), gui = "italic" },
	Function	 { gui = "bold" },
	TSFunction	 { gui = "bold" },
  }
end)
